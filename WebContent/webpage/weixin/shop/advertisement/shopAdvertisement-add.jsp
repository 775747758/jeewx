...
<script type="text/javascript">
	...
	$(function() {
		...
		//编辑时初始化图片预览
		var name = "${shopAdvertisementPage.name}", imageHref = "${shopAdvertisementPage.imgurl}";
		if (name != "") {
		...
		if (imageHref != "") {
			$("#imageShow")
					.html(
							'<img src="${shopAdvertisementPage.imgurl}" width="100%" height="160" />');
		}
	});
 ...
 <div class="main_bd">
		...
		<div class="media_edit_area" id="js_appmsg_editor">
			<div class="appmsg_editor" style="margin-top: 0px;">
				<div class="my_inner" >
					<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="shopAdvertisementController.do?doAdd" tiptype="1">
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
							<tr>
								...
								<td class="value"><input id="title" name="title"
									type="text" style="width: 150px" class="inputxt" datatype="*1-20">
									<span class="Validform_checktip"></span> <label
									class="Validform_label" style="display: none;">广告标题</label></td>
							</tr>
							<tr>
								<td align="right"><label class="Validform_label">
										链接商品: </label></td>
								<td class="value"><t:dictSelect field="idGood"
										type="list" dictTable="weixin_shop_good" dictField="id"
										dictText="name" 
										hasLabel="false" title="链接商品"></t:dictSelect> <span
									class="Validform_checktip"></span> <label
									class="Validform_label" style="display: none;">链接商品</label></td>
						...
						<span class="Validform_checktip"></span>
							...
							<tr>
								...
								<td class="value"><span
									...
									value="${shopAdvertisementPage.imgurl}" datatype="*"> <span
									id="imgName"></span> <span class="Validform_checktip"></span> <label
									class="Validform_label" style="display: none;">图片链接</label></td>
							</tr>
